...
__decorate([
    common_1.Get(':id'),
    swagger_1.ApiOperation({ summary: 'Get a user by id' }),
...
__decorate([
    common_1.Patch(':id'),
    swagger_1.ApiOperation({ summary: 'Update one of the user information' }),
    __param(0, common_1.Param('id')),
...
__decorate([
    common_1.Put(':id'),
    swagger_1.ApiOperation({ summary: 'Update all user information' }),
    __param(0, common_1.Param('id')),
    __param(1, common_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_user_dto_1.UpdateUserDto]),
